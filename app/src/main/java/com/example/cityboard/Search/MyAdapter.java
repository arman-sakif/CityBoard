...
import com.example.cityboard.Search.Member;
import com.firebase.ui.database.FirebaseRecyclerAdapter;
import com.firebase.ui.database.FirebaseRecyclerOptions;

public class MyAdapter extends FirebaseRecyclerAdapter<com.example.cityboard.Search.Member, com.example.cityboard.Search.MyAdapter.MyViewHolder> {

    public MyAdapter(@NonNull FirebaseRecyclerOptions<com.example.cityboard.Search.Member> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull com.example.cityboard.Search.MyAdapter.MyViewHolder holder, int position, @NonNull Member model) {
        ...
        /*holder.mTitleTV.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent descActivity = new Intent(context, DescActivity.class);
                descActivity.putExtra(DescActivity.EXTRA_ITEM, model.getName());
                context.startActivity(descActivity);
            }
        });*/
    }
    ...
    @NonNull
    @Override
    public com.example.cityboard.Search.MyAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view =  LayoutInflater.from(parent.getContext()).inflate(R.layout.image_search,parent,false);
        return new com.example.cityboard.Search.MyAdapter.MyViewHolder(view);
    }
    ...
    class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public MyViewHolder(@NonNull View itemView) {
            super(itemView);
            mImageIV = (ImageView) itemView.findViewById(R.id.searchImageViewID);
            mTitleTV = (TextView) itemView.findViewById(R.id.searchTitleTextViewID);
            mPriceTV = itemView.findViewById(R.id.searchPriceTextView);
            mTimeTV = itemView.findViewById(R.id.searchTimeTextView);
