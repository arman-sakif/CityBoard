...
public class MyAdapter extends FirebaseRecyclerAdapter<Member,MyAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view =  LayoutInflater.from(parent.getContext()).inflate(R.layout.image_services,parent,false);
    ...
    class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public MyViewHolder(@NonNull View itemView) {
            super(itemView);
            mImageIV = (ImageView) itemView.findViewById(R.id.servicesImageViewID);
            mTitleTV = (TextView) itemView.findViewById(R.id.servicesTitleTextViewID);
            mPriceTV = (TextView) itemView.findViewById(R.id.servicesPriceTextView);
            mTimeTV = (TextView) itemView.findViewById(R.id.servicesTimeTextView);
