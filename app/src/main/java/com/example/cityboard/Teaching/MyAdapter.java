...
public class MyAdapter extends FirebaseRecyclerAdapter<Member,MyAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view =  LayoutInflater.from(parent.getContext()).inflate(R.layout.image_teaching,parent,false);
    ...
    class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public MyViewHolder(@NonNull View itemView) {
            super(itemView);
            mImageIV = (ImageView) itemView.findViewById(R.id.teachingImageViewID);
            mTitleTV = (TextView) itemView.findViewById(R.id.teachingTitleTextViewID);
            mPriceTV = (TextView) itemView.findViewById(R.id.teachingPriceTextView);
            mTimeTV = (TextView) itemView.findViewById(R.id.teachingTimeTextView);
